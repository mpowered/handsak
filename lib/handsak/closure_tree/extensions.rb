    ...
    module Extensions
      ...
      def self.included(klass)
        ...
        def klass.most_senior
          most_senior_generation = joins(:ancestor_hierarchies).minimum("#{quoted_hierarchy_table_name}.generations")
        ...
        def klass.most_junior
          most_junior_generation = joins(:ancestor_hierarchies).maximum("#{quoted_hierarchy_table_name}.generations")
